...
def main():
    ...
    # We pass in jail_replacements to the function as an "argument".
    # Below simply peforms all the original functionality. As an exercise,
    # try slicing and dicing the code into new functions that do one thing,
    # similar to what we've done for the get_jail_name_substitutions function.
    # then invoke those functions in a logical order here.
    rest_of_code(jail_replacements)
